...
import pickle
import numpy as np
#Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass.\activate.ps1

# setup application
app = Flask(__name__)

def prediction(lst):
    filename = 'C:/Users/User/Desktop/IM PR & ML/ML Couse/Code_pro/Project/My/web site in flask/predictor.pickle'
